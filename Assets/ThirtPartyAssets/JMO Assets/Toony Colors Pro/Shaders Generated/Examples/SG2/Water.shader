...
Shader "Toony Colors Pro 2/Examples/SG2/Water"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[TCP2UVScrolling] _FoamTex_SC ("Foam Texture Custom UV Scrolling", Vector) = (1,1,0,0)
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float3 __foamTextureCustom = ( tex2D(_FoamTex, input.texcoord0.xy * _FoamTex_ST.xy + frac(_Time.yy * _FoamTex_SC.xy) + _FoamTex_ST.zw).rgb );
			float __foamMask = ( .0 );

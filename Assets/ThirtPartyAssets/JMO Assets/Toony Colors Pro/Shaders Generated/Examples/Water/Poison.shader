...
Shader "Toony Colors Pro 2/Examples/Water/Poison"
{
	...
	SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutputWater o)
		{
			...
			_Color.rgb = lerp(_Color.rgb, _MaskedColor.rgb, mask3.r);
			...
			emissionCol *= lerp(_EmisPulseMin, 1, sin((TIME + mask2.g * 4) * _EmisPulseSpeed)*0.5+0.5);

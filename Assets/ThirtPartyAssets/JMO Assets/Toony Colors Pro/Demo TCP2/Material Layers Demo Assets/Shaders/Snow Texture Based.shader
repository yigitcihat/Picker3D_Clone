...
Shader "Toony Colors Pro 2/Examples/Material Layers/Snow (Texture Based)"
{
	Properties
	{
		...
		[TCP2Separator]
		[TCP2Header(Snow)]
		_layer_8f0527 ("Source Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float __layer_snow = saturate( tex2D(_layer_8f0527, input.texcoord0.xy * _layer_8f0527_ST.xy + _layer_8f0527_ST.zw).r );
